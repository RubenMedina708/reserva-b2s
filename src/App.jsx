  ...
  return (
    <Shell>
      <div className="max-w-3xl mx-auto bg-white rounded-2xl border shadow-sm p-6">
        ...
        <div className="rounded-lg bg-indigo-50 text-indigo-900 border border-indigo-200 p-3 text-sm mb-4"><b>Instrucciones de Pago:</b> Transfiere <b>${total.toLocaleString("es-MX")} MXN</b> a la cuenta CLABE <b>137528105116209401</b> a nombre de <b>Itzel Magaña García</b> y adjunta tu comprobante.</div>
